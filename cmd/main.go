...
import (
	...
	"github.com/PayeTonKawa-EPSI-2025/Orders/internal/db"
	"github.com/PayeTonKawa-EPSI-2025/Orders/internal/operation"
...
// Options for the CLI.
type Options struct {
	Port int `help:"Port to listen on" short:"p" default:"8082"`
}
